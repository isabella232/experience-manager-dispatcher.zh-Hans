...
seo-description: 了解如何在 Microsoft Internet Information Server、Apache Web Server 和 Sun Java Web Server-iPlanet 上安装 AEM Dispatcher 模块。
...
1. 打开 IIS Manager 并选择您将用作 Disptcher 缓存的网站。
